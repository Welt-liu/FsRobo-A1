...
: ${AMENT_CURRENT_PREFIX:="/home/ny/FsRobo-A1/install/fsrobo-a1-msg_srv_4py"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fsrobo-a1-msg_srv_4py/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fsrobo-a1-msg_srv_4py/environment/path.sh"
