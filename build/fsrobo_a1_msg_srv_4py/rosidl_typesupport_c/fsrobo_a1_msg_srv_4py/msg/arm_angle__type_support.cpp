...
static const _ArmAngle_type_support_symbol_names_t _ArmAngle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fsrobo_a1_msg_srv_4py, msg, ArmAngle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fsrobo_a1_msg_srv_4py, msg, ArmAngle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fsrobo_a1_msg_srv_4py, msg, ArmAngle)() {
  return &::fsrobo_a1_msg_srv_4py::msg::rosidl_typesupport_c::ArmAngle_message_type_support_handle;
}
