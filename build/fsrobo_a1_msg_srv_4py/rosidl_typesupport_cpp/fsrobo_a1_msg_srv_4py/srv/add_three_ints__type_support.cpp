...
static const _AddThreeInts_Request_type_support_symbol_names_t _AddThreeInts_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fsrobo_a1_msg_srv_4py, srv, AddThreeInts_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fsrobo_a1_msg_srv_4py, srv, AddThreeInts_Request)),
  }
};
...
{
  return &::fsrobo_a1_msg_srv_4py::srv::rosidl_typesupport_cpp::AddThreeInts_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fsrobo_a1_msg_srv_4py, srv, AddThreeInts_Request)() {
  return get_message_type_support_handle<fsrobo_a1_msg_srv_4py::srv::AddThreeInts_Request>();
}
...
static const _AddThreeInts_Response_type_support_symbol_names_t _AddThreeInts_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fsrobo_a1_msg_srv_4py, srv, AddThreeInts_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fsrobo_a1_msg_srv_4py, srv, AddThreeInts_Response)),
  }
};
...
{
  return &::fsrobo_a1_msg_srv_4py::srv::rosidl_typesupport_cpp::AddThreeInts_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fsrobo_a1_msg_srv_4py, srv, AddThreeInts_Response)() {
  return get_message_type_support_handle<fsrobo_a1_msg_srv_4py::srv::AddThreeInts_Response>();
}
...
static const _AddThreeInts_type_support_symbol_names_t _AddThreeInts_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fsrobo_a1_msg_srv_4py, srv, AddThreeInts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fsrobo_a1_msg_srv_4py, srv, AddThreeInts)),
  }
};
...
{
  return &::fsrobo_a1_msg_srv_4py::srv::rosidl_typesupport_cpp::AddThreeInts_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, fsrobo_a1_msg_srv_4py, srv, AddThreeInts)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<fsrobo_a1_msg_srv_4py::srv::AddThreeInts>();
}
