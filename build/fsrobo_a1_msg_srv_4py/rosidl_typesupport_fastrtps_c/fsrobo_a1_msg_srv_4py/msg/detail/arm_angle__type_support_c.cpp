...
#include "fsrobo_a1_msg_srv_4py/msg/detail/arm_angle__rosidl_typesupport_fastrtps_c.h"
...
using _ArmAngle__ros_msg_type = fsrobo_a1_msg_srv_4py__msg__ArmAngle;
...
size_t get_serialized_size_fsrobo_a1_msg_srv_4py__msg__ArmAngle(
  const void * untyped_ros_message,
...
static uint32_t _ArmAngle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fsrobo_a1_msg_srv_4py__msg__ArmAngle(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsrobo_a1_msg_srv_4py
size_t max_serialized_size_fsrobo_a1_msg_srv_4py__msg__ArmAngle(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _ArmAngle__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_fsrobo_a1_msg_srv_4py__msg__ArmAngle(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ArmAngle = {
  "fsrobo_a1_msg_srv_4py::msg",
  "ArmAngle",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fsrobo_a1_msg_srv_4py, msg, ArmAngle)() {
