...
#include "fsrobo_a1_msg_srv_4py/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const fsrobo_a1_msg_srv_4py::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fsrobo_a1_msg_srv_4py::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &fsrobo_a1_msg_srv_4py::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
