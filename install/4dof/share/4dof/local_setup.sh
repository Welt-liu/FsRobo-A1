...
: ${AMENT_CURRENT_PREFIX:="/home/ny/FsRobo-A1/install/4dof"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/4dof/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/4dof/environment/path.sh"
