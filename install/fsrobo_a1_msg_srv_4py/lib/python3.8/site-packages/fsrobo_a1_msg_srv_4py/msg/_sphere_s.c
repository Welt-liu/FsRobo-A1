...
bool fsrobo_a1_msg_srv_4py__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fsrobo_a1_msg_srv_4py.msg._sphere.Sphere", full_classname_dest, 40) == 0);
  }
  fsrobo_a1_msg_srv_4py__msg__Sphere * ros_message = _ros_message;
  {  // center
...
PyObject * fsrobo_a1_msg_srv_4py__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fsrobo_a1_msg_srv_4py.msg._sphere");
