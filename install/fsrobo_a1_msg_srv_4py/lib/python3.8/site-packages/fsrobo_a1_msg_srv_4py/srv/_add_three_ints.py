...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'fsrobo_a1_msg_srv_4py.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from fsrobo_a1_msg_srv_4py.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from fsrobo_a1_msg_srv_4py.srv._add_three_ints import AddThreeInts_Request as Request
    from fsrobo_a1_msg_srv_4py.srv._add_three_ints import AddThreeInts_Response as Response
