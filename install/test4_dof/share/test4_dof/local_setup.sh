...
: ${AMENT_CURRENT_PREFIX:="/home/ny/FsRobo-A1/install/test4_dof"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test4_dof/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test4_dof/environment/path.sh"
